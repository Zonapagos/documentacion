...
<Note> **Nota:** Los medios de pago disponibles para el usuario final dependerán de la configuración comercial y habilitación realizada para cada comercio. </Note>
<Warning> **Importante:** Para la modalidad **Zonaexpress** no aplica el modelo de integración mediante **Caja Banco Web Services**. </Warning>
